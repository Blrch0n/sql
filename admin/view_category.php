...
<div class="admin-container">
    ...
    <div style="margin-bottom: 20px;">
        <a href="add_category.php" class="btn btn-secondary">Буцах</a>
    </div>
    ...
    <?php if ($category): ?>
        <div class="card" style="padding: 20px; border: 1px solid #ccc; border-radius: 8px;">
            ...
            <p style="color: green; font-size: 0.9em;">
                🛡️ <b>SQL Injection хамгаалагдсан:</b> Таны хайсан нэрийг PDO Prepared Statement ашиглан баазуу хувиргаж хайлт хийсэн.
            </p>
        </div>
    <?php else: ?>
